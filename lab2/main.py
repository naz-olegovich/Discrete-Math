...
class Main:
    ...
    def window2(self):
        ...
        b_w = Button(self.win2, text="Save to", bg='#FF8C00', activebackground='#284C79', relief=FLAT, command=set_W)
        ...
        save_to_m = Button(self.win2, text="Save to", bg='#FF8C00', activebackground='#284C79', relief=FLAT, command=set_M)
    ...
    def S_relation(self):
        ...
        for node1 in range(len(list(self.A))):
            color_map.append('blue')
        for nod2 in range(len(list(self.B))):
            color_map.append('green')
